...
print(my_text, " I am a swimmer ", question)
...
#Type your code here.
global_mean_sea_level_2018= 69.420
...
bucket_list = ("writing a song", "travel around Asia", "attend UCB")
print(bucket_list)
